...
@section('title', '401 - Unauthorized - ' . config('app.name'))
@section('description', '401 - Unauthorized')
@section('keywords', '401, unauthorized')
        ...
        <div class="container py-5">
            <div class="row align-items-center error-row py-5">
                ...
                <div class="col-12 col-lg-6 order-1 order-lg-2 error-illustration">
                    <img src="{{ asset('images/d/errors/401.png') }}" 
                         alt="401 Error Illustration" 
                         onerror="this.src='https://via.placeholder.com/600x500/227447/FFFFFF?text=401+Error'">
                </div>
            </div>
        </div>
    </section>
