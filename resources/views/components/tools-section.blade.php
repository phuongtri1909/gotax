                ...
                <a href="{{ $tool['link'] }}" class="tool-card">
                    <div class="tool-icon">
                        @if($tool['icon'] === 'invoice')
                            <img src="{{ asset('images/svg/tools/go-invoice.svg') }}" alt="Invoice" width="64" height="64">
                        @elseif($tool['icon'] === 'bot')
                            <img src="{{ asset('images/svg/tools/go-bot.svg') }}" alt="Bot" width="64" height="64">
                        @elseif($tool['icon'] === 'soft')
                            <img src="{{ asset('images/svg/tools/go-soft.svg') }}" alt="Soft" width="64" height="64">
                        @elseif($tool['icon'] === 'quick')
                            <img src="{{ asset('images/svg/tools/go-quick.svg') }}" alt="Quick" width="64" height="64">
                        @endif
                    </div>
                    <h3 class="tool-title">
                        @php
