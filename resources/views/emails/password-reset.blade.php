...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn tại <strong>{{ config('app.name') }}</strong>.</p>
            ...
            <div class="warning">
                ...
                <ul style="margin: 10px 0; padding-left: 20px;">
                    ...
                    <li>Mật khẩu của bạn sẽ không thay đổi cho đến khi bạn nhấp vào liên kết trên và tạo mật khẩu mới.</li>
                </ul>
            </div>
        </div>
