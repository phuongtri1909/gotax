...
@section('title', 'Quản lý gói GoSoft')
        ...
        <div class="content-card">
            <div class="card-top">
                <div class="card-title">
                    ...
                    <h5>Danh sách gói GoSoft</h5>
                </div>
                <a href="{{ route('admin.go-soft-packages.create') }}" class="action-button">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons-wrapper">
                                                <a href="{{ route('admin.go-soft-packages.show', $package) }}"
                                                    class="action-icon view-icon text-decoration-none" title="Xem chi tiết">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.go-soft-packages.edit', $package) }}"
                                                ...
                                                @include('components.delete-form', [
                                                    'id' => $package->id,
                                                    'route' => route('admin.go-soft-packages.destroy', $package),
