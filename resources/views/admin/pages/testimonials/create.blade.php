...
@section('title', 'Thêm đánh giá khách hàng')
        ...
        <div class="form-card">
            <div class="form-header">
                <div class="form-title">
                    ...
                    <h5>Thêm đánh giá khách hàng</h5>
                </div>
            </div>

            <div class="form-body">
                <form action="{{ route('admin.testimonials.store') }}" method="POST" class="category-form" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="text" name="text" rows="4" class="custom-input {{ $errors->has('text') ? 'input-error' : '' }}" required placeholder="Nhập nội dung đánh giá...">{{ old('text') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="custom-input {{ $errors->has('name') ? 'input-error' : '' }}" value="{{ old('name') }}" required placeholder="Nhập tên khách hàng">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-hint">
                                        ...
                                        <span>Định dạng: JPEG, PNG, JPG, GIF. Kích thước tối đa: 2MB.</span>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="order" name="order" class="custom-input {{ $errors->has('order') ? 'input-error' : '' }}" value="{{ old('order', 0) }}" min="0" step="1">
                                    <div class="form-hint">
                                        <i class="fas fa-info-circle"></i>
