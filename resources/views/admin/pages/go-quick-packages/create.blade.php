...
@section('title', 'Thêm gói GoQuick')
        ...
        <div class="form-card">
            <div class="form-header">
                <div class="form-title">
                    ...
                    <h5>Thêm gói GoQuick</h5>
                </div>
            </div>

            <div class="form-body">
                <form action="{{ route('admin.go-quick-packages.store') }}" method="POST" class="category-form">
                    @csrf
