...
@section('title', 'Quản lý gói GoQuick')
        ...
        <div class="content-card">
            <div class="card-top">
                <div class="card-title">
                    ...
                    <h5>Danh sách gói GoQuick</h5>
                </div>
                <a href="{{ route('admin.go-quick-packages.create') }}" class="action-button">
                        ...
                        <table class="data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="column-medium">Giới hạn CCCD</th>
                            ...
                            <tbody>
                                @foreach ($packages as $index => $package)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="limit-badge">{{ number_format($package->cccd_limit) }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="action-buttons-wrapper">
                                                <a href="{{ route('admin.go-quick-packages.show', $package) }}"
                                                    class="action-icon view-icon text-decoration-none" title="Xem chi tiết">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.go-quick-packages.edit', $package) }}"
                                                ...
                                                @include('components.delete-form', [
                                                    'id' => $package->id,
                                                    'route' => route('admin.go-quick-packages.destroy', $package),
