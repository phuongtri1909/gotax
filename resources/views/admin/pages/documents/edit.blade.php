...
@section('main-content')
    <div class="category-form-container">
        <div class="form-card">
            ...
            <div class="form-body">
                <form action="{{ route('admin.documents.update', $document) }}" method="POST" class="category-form" id="documentForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" class="custom-input {{ $errors->has('title') ? 'input-error' : '' }}" value="{{ old('title', $document->title) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="slug" name="slug" class="custom-input {{ $errors->has('slug') ? 'input-error' : '' }}" value="{{ old('slug', $document->slug) }}">
                                    <div class="form-hint">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="content" name="content" class="custom-input {{ $errors->has('content') ? 'input-error' : '' }}">{{ old('content', $document->content) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="order" name="order" class="custom-input {{ $errors->has('order') ? 'input-error' : '' }}" value="{{ old('order', $document->order) }}" min="0" step="1">
                                    <div class="form-hint">
                                        <i class="fas fa-info-circle"></i>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="custom-input {{ $errors->has('status') ? 'input-error' : '' }}" required>
                                        <option value="active" {{ old('status', $document->status) === 'active' ? 'selected' : '' }}>Kích hoạt</option>
                                        <option value="inactive" {{ old('status', $document->status) === 'inactive' ? 'selected' : '' }}>Tắt</option>
                                    </select>
                    ...
                    <div class="form-actions">
                        <a href="{{ route('admin.documents.index') }}" class="back-button">
