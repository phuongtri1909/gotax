...
@section('main-content')
    <div class="category-form-container">
        <div class="form-card">
            ...
            <div class="form-body">
                <form action="{{ route('admin.documents.store') }}" method="POST" class="category-form" id="documentForm">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" class="custom-input {{ $errors->has('title') ? 'input-error' : '' }}" value="{{ old('title') }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="slug" name="slug" class="custom-input {{ $errors->has('slug') ? 'input-error' : '' }}" value="{{ old('slug') }}">
                                    <div class="form-hint">
