...
@section('title', 'Chỉnh sửa gói GoInvoice')
        ...
        <div class="form-card">
            <div class="form-header">
                <div class="form-title">
                    ...
                    <h5>Chỉnh sửa gói GoInvoice</h5>
                </div>
                <div class="category-meta">
                    <div class="category-badge name">
                        <i class="fas fa-box"></i>
                        <span>{{ $goInvoicePackage->name }}</span>
                    </div>
                    <div class="category-badge slug">
                        <i class="fas fa-code"></i>
                        <span>{{ $goInvoicePackage->slug }}</span>
                    </div>
                    <div class="category-badge created">
                        <i class="fas fa-calendar"></i>
                        <span>Ngày tạo: {{ $goInvoicePackage->created_at->format('d/m/Y H:i') }}</span>
                    </div>
                </div>
            </div>

            <div class="form-body">
                <form action="{{ route('admin.go-invoice-packages.update', $goInvoicePackage) }}" method="POST" class="category-form" id="package-form">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" 
                                           ...
                                           value="{{ old('name', $goInvoicePackage->name) }}" required>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="price" name="price" step="0.01" min="0"
                                           ...
                                           value="{{ old('price', $goInvoicePackage->price) }}" required>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="mst_limit" name="mst_limit" min="1"
                                           ...
                                           value="{{ old('mst_limit', $goInvoicePackage->mst_limit) }}" required>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="license_fee" name="license_fee" step="0.01" min="0"
                                           ...
                                           value="{{ old('license_fee', $goInvoicePackage->license_fee) }}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="discount_percent" name="discount_percent" min="0" max="100"
                                           ...
                                           value="{{ old('discount_percent', $goInvoicePackage->discount_percent) }}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="badge" name="badge" 
                                           ...
                                           value="{{ old('badge', $goInvoicePackage->badge) }}" placeholder="VD: Phổ biến, Nổi bật">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="order" name="order" min="0"
                                           ...
                                           value="{{ old('order', $goInvoicePackage->order) }}">
                                    <div class="form-hint">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="status" name="status" 
                                        ...
                                        <option value="inactive" {{ old('status', $goInvoicePackage->status) === 'inactive' ? 'selected' : '' }}>Tắt</option>
                                        <option value="active" {{ old('status', $goInvoicePackage->status) === 'active' ? 'selected' : '' }}>Kích hoạt</option>
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" rows="4"
                                              class="custom-input {{ $errors->has('description') ? 'input-error' : '' }}">{{ old('description', $goInvoicePackage->description) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="features" name="features_text" rows="6"
                                              ...
                                              placeholder="Nhập mỗi tính năng trên một dòng">@if($goInvoicePackage->features){{ implode("\n", $goInvoicePackage->features) }}@endif</textarea>
                                    <div class="form-hint">
                                        <i class="fas fa-info-circle"></i>
