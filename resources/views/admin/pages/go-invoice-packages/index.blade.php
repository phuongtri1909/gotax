...
@section('title', 'Quản lý gói GoInvoice')
        ...
        <div class="content-card">
            <div class="card-top">
                <div class="card-title">
                    ...
                    <h5>Danh sách gói GoInvoice</h5>
                </div>
                <a href="{{ route('admin.go-invoice-packages.create') }}" class="action-button">
                        ...
                        <table class="data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="column-medium">Phí bản quyền</th>
                                ...
                                @foreach ($packages as $index => $package)
                                    <tr>
                                        ...
                                        <td class="item-title">
                                            ...
                                            @if($package->badge)
                                                <span class="badge-badge">{{ $package->badge }}</span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fee-badge">{{ number_format($package->license_fee, 0, ',', '.') }} đ</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="action-buttons-wrapper">
                                                <a href="{{ route('admin.go-invoice-packages.show', $package) }}"
                                                    class="action-icon view-icon text-decoration-none" title="Xem chi tiết">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.go-invoice-packages.edit', $package) }}"
                                                ...
                                                @include('components.delete-form', [
                                                    'id' => $package->id,
                                                    'route' => route('admin.go-invoice-packages.destroy', $package),
