                ...
                <form action="{{ route('admin.faqs.store') }}" method="POST" class="category-form">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="question" name="question" rows="3" class="custom-input {{ $errors->has('question') ? 'input-error' : '' }}" required>{{ old('question') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="answer" name="answer" rows="6" class="custom-input {{ $errors->has('answer') ? 'input-error' : '' }}" required>{{ old('answer') }}</textarea>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="save-button">
                            <i class="fas fa-save"></i> Tạo câu hỏi
                        </button>
                    </div>
                </form>
            </div>
