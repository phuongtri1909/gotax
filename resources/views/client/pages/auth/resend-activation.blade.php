    ...
    <div class="login-page-container container container-page">
        ...
        <div class="login-container">
            <div class="login-card">
                <h2 class="login-title">Gửi Lại Email Kích Hoạt</h2>
                <p class="login-subtitle">Vui lòng nhập email đã đăng ký để nhận lại email kích hoạt tài khoản.</p>

                @include('components.toast-main')
                @include('components.toast')

                <form method="POST" action="{{ route('resend-activation.post') }}" class="login-form">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                            ...
                            placeholder="Email đã đăng ký" required autofocus>
                        @error('email')
