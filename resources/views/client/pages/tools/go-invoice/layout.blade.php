...
@section('title', 'Go Invoice - Tải Hoá Đơn Điện Tử Hàng Loạt')
@section('description', 'Go Invoice - Tải Hoá Đơn Điện Tử Hàng Loạt')
@section('keyword', 'Go Invoice, Hoá Đơn')

@section('content')
    <section class="go-invoice-section">
        <div class="container-fluid">
            <div class="row">
                <!-- Sidebar -->
                <div class="col-lg-3 col-md-4 go-invoice-sidebar">
                    <nav class="sidebar-menu">
                        <a href="{{ route('tools.go-invoice.overview') }}" class="sidebar-menu-item {{ request()->routeIs('tools.go-invoice.overview') ? 'active' : '' }}">
                        ...
                        <a href="{{ route('tools.go-invoice.process') }}" class="sidebar-menu-item {{ request()->routeIs('tools.go-invoice.process') ? 'active' : '' }}">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                            ...
                            <span>Xử lý hoá đơn</span>
                        </a>
                        <a href="{{ route('tools.go-invoice.storage') }}" class="sidebar-menu-item {{ request()->routeIs('tools.go-invoice.storage') ? 'active' : '' }}">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <a href="{{ route('tools.go-invoice.support') }}" class="sidebar-menu-item {{ request()->routeIs('tools.go-invoice.support') ? 'active' : '' }}">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <a href="#" class="sidebar-menu-item" id="addCompanyBtn">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <!-- Main Content -->
                <div class="col-lg-9 col-md-8 go-invoice-content-wrapper">
                    <!-- Header -->
                    <div class="content-header">
                        <h1 class="content-title">Go Invoice</h1>
                        <p class="content-subtitle">Tải Hoá Đơn Điện Tử Hàng Loạt</p>
                    </div>
                    
                    <!-- Content -->
                    <div class="go-invoice-content">
                        @yield('go-invoice-content')
                    </div>
                </div>
            </div>
            
            <!-- Back Button - Outside sidebar -->
            <div class="section-back">
                <a href="{{ route('tools.go-invoice') }}" class="btn btn-back-section">
...
@push('styles')
    @vite('resources/assets/frontend/css/pages/tools/go-invoice-tools.css')
@endpush
